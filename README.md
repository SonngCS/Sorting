...
- The program currently isn't finished and the idea is to modify "printHeap" in print.h to show the entire heap in a binary tree shape;

- For a next project, I want to use the assets made in sortingChoice and make a sorting visualizer in C++, with opengl.
